        ...
        <div class="max-w-sm w-full text-gray-600">
            ...
            >
                <div>
                    ...
                    <input v-model="userEmail" type="email" autocomplete="email" required class="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"/>
                </div>
                <div>
                    <label class="font-medium">
                        Password
                    </label>
                    <input v-model="userPassword" type="password" autocomplete="current-password" required class="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"/>
                </div>
