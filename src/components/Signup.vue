      ...
      <div class="max-w-sm w-full text-gray-600">
        ...
        <form @submit.prevent="handleSignup()" class="mt-8 space-y-5">
          ...
          <div>
            ...
            <input v-model="userPassword" type="password" required autocomplete="current-password" class="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"/>
          </div>
