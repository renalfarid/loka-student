    ...
    <div class="flex flex-col h-full">
        <div class='h-20 flex items-center px-8 mt-10 mb-10'>
            <a href='javascript:void(0)' class='flex-none'>
                <img src="/images/loka.jpeg" width={140} class="mx-auto" />
            </a>
        </div>
        <div class="flex-1 flex flex-col h-full overflow-auto">
            <ul class="px-4 text-sm font-medium flex-1">
                <li v-for="item in menuItems" :key="item.title" class="text-gray-700 hover:text-gray-900">
                    <a :href="item.href" class="flex items-center gap-x-2 text-gray-600 p-2 rounded-lg  hover:bg-gray-50 active:bg-gray-100 duration-150">
                        <div class="text-gray-500"><span v-html="item.icon"></span></div>
                        {{item.name}}
                        </a>
                </li>
